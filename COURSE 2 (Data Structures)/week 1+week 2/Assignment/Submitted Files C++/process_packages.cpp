...
public:
    ...
    Response Process(const Request &request) {
        if (finish_time_.empty() && size_ > 0) {
            ...
            Response *r=new Response(false, request.arrival_time);
            return *r;
        } else {
            ...
            if (finish_time_.size() == size_) {
                Response *r=new Response(true, -1);
                return *r;
                ...
                finish_time_.push_back(t + request.process_time);
                Response *r=new Response(false, t);
                return *r;
            }
        }
    }
