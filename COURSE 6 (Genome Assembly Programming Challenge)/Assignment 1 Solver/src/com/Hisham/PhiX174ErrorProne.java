...
// but that can cause time issue(not always) for this problem to pass the grader and dont know why,that implementation
// didn't pass the grader. So,here is another implementation which is easier to implement
